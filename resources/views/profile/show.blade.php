                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputPassword2" readonly
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="exampleInputPassword3"
                                            value="{{ $profile->date_of_birth }}" name="date_of_birth" readonly>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword5" class="form-label">Gender</label>
                                        <select class="form-select" id="exampleInputPassword5" required disabled
                                            name="gender">
