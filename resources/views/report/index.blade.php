                ...
                <div class="container-fluid">
                    ...
                    <div class="row border shadow p-2 rowbox">
                        <div class="col-3 col-sm-3 col-md-3 ">
                            ...
                            <a href="{{ route('report.edit', 0) }}" class="btn btn-block btn-success btn">Create
                                report</a>
                        </div>
                        <div class="col-9 col-sm-9 col-md-9 d-flex justify-content-end">

                            <a href="{{ route('create.pdf') }}" class="btn btn-block btn-success ">
                                Export Pdf</a>
                        </div>
                        <div class="col-12 col-sm-12 col-md-12 mt-2 table-responsive">
                            <label style="font-weight: 700; font-size: 20px; padding-left: 40%;">report</label>
                            <table class="table table-sm">
                                <thead>
                                    <tr>
                                        <th class="p-1">#</th>
                                        <th class="p-1">Title</th>
                                        <th class="p-1">Description
                                        </th>
                                ...
                                <tbody>
                                    @forelse ($report as $key=>$value)
                                        <tr>
                                            ...
                                            <td class="p-1" class="p-1">{{ $value->title }}</td>
                                            <td class="p-1">{{ $value->description }}</td>

                                            <td class="p-1">
                                                <a href="{{ route('report.edit', $value->id) }}" title="Edit"><i
                                                        class="fa fa-edit"></i></a>
                                                <a href="{{ route('report.show', $value->id) }}" title="Show"><i
                                                        class="fa fa-eye"></i></a>
                                                <a href="{{ route('report.delete', $value->id) }}" title="Delete"
